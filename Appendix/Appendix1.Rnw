...
b. The sample mean\\
\newpage
\noindent c. The standard deviation of the sample mean\\
d. None of the above\\
...
\newpage
\noindent c. A p-value of .0025 provides evidence that Mrs. Rose is an exceptional teacher who was able to prepare her students well for this national test.\\
d. None of the above.\\
