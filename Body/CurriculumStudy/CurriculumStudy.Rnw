...
\begin{center}
\textbf{Status}: Submitted for Review to \textit{Techology Innovations in Statistics Education} (TISE)\\
\end{center} 
...
% %-------------------------------------------------------
% %\appendix (moved to Appendix1.Rnw)
% %-------------------------------------------------------
